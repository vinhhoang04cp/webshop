...
{{-- Layout với sidebar cho Admin/Manager --}}
    ...
    <div class="row g-0">
        ...
        <div class="col-md-9 col-lg-10 dashboard-content">
            <div class="dashboard-header">
                <div>
                    <h2><i class="fas fa-user-circle me-2"></i>Quản lý tài khoản</h2>
                    <p class="text-muted mb-0">Cập nhật thông tin cá nhân và bảo mật tài khoản</p>
                </div>
            </div>
...
<div class="container mt-4 mb-5">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <ul class="nav nav-tabs mb-3" id="profileTabs" role="tablist" style="border-bottom: 2px solid #e5e7eb;">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="profile-tab-customer" data-bs-toggle="tab" data-bs-target="#profile-customer" type="button" style="border: none; color: #6b7280; font-weight: 600;">
                        <i class="fas fa-user me-2"></i>Thông tin cá nhân
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="password-tab-customer" data-bs-toggle="tab" data-bs-target="#password-customer" type="button" style="border: none; color: #6b7280; font-weight: 600;">
                        <i class="fas fa-key me-2"></i>Đổi mật khẩu
                    </button>
                </li>
            </ul>
            ...
            <!-- Tab Content -->
            <div class="tab-content" id="profileTabsContentCustomer">
                <!-- Thông tin cá nhân -->
                <div class="tab-pane fade show active" id="profile-customer" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Cập nhật thông tin cá nhân</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="name-customer" class="form-label">Họ tên <span class="text-danger">*</span></label>
                                    <input type="text" 
                                           class="form-control @error('name') is-invalid @enderror" 
                                           id="name-customer" 
                                           name="name" 
                                ...
                                <div class="mb-3">
                                    <label for="email-customer" class="form-label">Email</label>
                                    <input type="email" 
                                           class="form-control" 
                                           id="email-customer" 
                                           value="{{ $user->email }}" 
                                ...
                                <div class="mb-3">
                                    <label for="phone-customer" class="form-label">Số điện thoại</label>
                                    <input type="text" 
                                           class="form-control @error('phone') is-invalid @enderror" 
                                           id="phone-customer" 
                                           name="phone" 
                                ...
                                <div class="mb-3">
                                    <label for="address-customer" class="form-label">Địa chỉ</label>
                                    <textarea class="form-control @error('address') is-invalid @enderror" 
                                              id="address-customer" 
                                              name="address" 
                                              rows="3">{{ old('address', $user->address) }}</textarea>
                                ...
                                <div class="mb-3">
                                    <label for="avatar-customer" class="form-label">Ảnh đại diện</label>
                                    <input type="file" 
                                           class="form-control @error('avatar') is-invalid @enderror" 
                                           id="avatar-customer" 
                                           name="avatar" 
                ...
                <!-- Đổi mật khẩu -->
                <div class="tab-pane fade" id="password-customer" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Đổi mật khẩu</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('profile.password') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="current_password-customer" class="form-label">Mật khẩu hiện tại <span class="text-danger">*</span></label>
                                    <input type="password" 
                                           class="form-control @error('current_password') is-invalid @enderror" 
                                           id="current_password-customer" 
                                           name="current_password" 
                                           required>
                                    @error('current_password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    <label for="new_password-customer" class="form-label">Mật khẩu mới <span class="text-danger">*</span></label>
                                    <input type="password" 
                                           class="form-control @error('new_password') is-invalid @enderror" 
                                           id="new_password-customer" 
                                           name="new_password" 
                                           required>
                                    @error('new_password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    <label for="new_password_confirmation-customer" class="form-label">Xác nhận mật khẩu mới <span class="text-danger">*</span></label>
                                    <input type="password" 
                                           class="form-control" 
                                           id="new_password_confirmation-customer" 
                                           name="new_password_confirmation" 
                                           required>
                                </div>
