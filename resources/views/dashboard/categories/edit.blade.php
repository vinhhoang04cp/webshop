...
@section('title', 'Chỉnh sửa danh mục - WebShop Admin')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('dashboard.categories.show', $category->category_id) }}" class="btn btn-outline-info me-2">
                            ...
                            <div class="col-md-4">
                                <div class="card bg-light mb-3">
                                    <div class="card-body">
                                        ...
                                        <ul class="small mb-0">
                                            <li><strong>ID:</strong> {{ $category->category_id }}</li>
                                            <li><strong>Tạo lúc:</strong> {{ $category->created_at ? $category->created_at->format('d/m/Y H:i') : 'N/A' }}</li>
                                            <li><strong>Cập nhật:</strong> {{ $category->updated_at ? $category->updated_at->format('d/m/Y H:i') : 'N/A' }}</li>
                                        </ul>
                                    </div>
                                </div>
